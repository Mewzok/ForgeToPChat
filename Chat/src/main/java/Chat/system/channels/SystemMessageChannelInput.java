...
public class SystemMessageChannelInput implements MutableMessageChannel
{
	private Set<MessageReceiver> members;
	
	public SystemMessageChannelInput()
	{
		this(Collections.emptySet());
	}
	
	public SystemMessageChannelInput(Collection<MessageReceiver> members)
	{
