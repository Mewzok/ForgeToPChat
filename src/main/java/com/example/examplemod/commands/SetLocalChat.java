...
public class SetLocalChat implements ICommand
{
	...
	{
		// TODO Auto-generated method stub
		return "Sets your current chat mode to Local.";
	}
	...
	public List<String> getAliases()
	{
		...
		commandAliases.add("local");
		commandAliases.add("localchat");
		commandAliases.add("l");
